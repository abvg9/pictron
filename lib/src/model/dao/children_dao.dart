...
class ChildrenDao extends Dao {
  ...
  Future<List<Child>> getChildren(String id) =>
      post(_urlChildren, body: <String, String>{
        'Tutor': id
        ...
        return childrenList.map<Child>((dynamic json) =>
                Child.fromJson(json)).toList();

      }).catchError((Object e) => throw e);


  Future<List<ChildrenGroup>> _getIdGroups(String id) =>
      post(_urlIdGroups, body: <String, String>{
        'Tutor': id
      }).then((dynamic response) async {
        ...
        return childrenList.map<ChildrenGroup>((dynamic json) =>
            ChildrenGroup.fromJson(json)).toList();
