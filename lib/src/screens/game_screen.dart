              ...
              children: <Widget>[
                Expanded(
                    ...
                    child: Container(
                      ...
                      Expanded(
                          flex: 3,
                          child: Text(_currentPage.names[_currentPage.sol],
                ...
                Expanded(
                    ...
                    child: Row(children: <Widget>[
                      Expanded(
                          child:
                              Ink.image(image: AssetImage(_feedbackPath[0]))),
                      Expanded(
                          child:
                              Ink.image(image: AssetImage(_feedbackPath[1]))),
                      Expanded(
                          child: Ink.image(image: AssetImage(_feedbackPath[2])))
                    ])),
              ],
            )),
      );
